...
const schema = z.object({
  title : z.string().min(1,{message:"Title should be at least 1 character long"}),
  description : z.string().min(1,{message:"Description should be at least 1 character long"}),
  ...
  requirements : z.string().min(1,{message:"Requirements should be at least 1 character long"}),
})
